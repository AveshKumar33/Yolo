...
export class MongooseConfigService implements MongooseOptionsFactory {
  ...
  createMongooseOptions(): MongooseModuleOptions {
    try {
      ...
      console.log(
        `mongodb+srv://${username}:${password}@cluster0.jbyq6le.mongodb.net/${databasename}?retryWrites=true&w=majority`,
      );
      return {
        uri: `mongodb+srv://${username}:${password}@cluster0.ifzjxon.mongodb.net/${databasename}?retryWrites=true&w=majority&appName=Cluster0`,
      };
    } catch (error) {
